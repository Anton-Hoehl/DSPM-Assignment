...
The API key is store in a seperate R file to protect it from unauthorized access. The file containing the key is also not submitted to github to protect it. 
